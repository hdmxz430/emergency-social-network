/* a list of 119 common english words. Basically a list of Stop Words. */
const stopWords =
    new Set(['a','able','about','across','after','all','almost','also','am','among','an','and','any',
...
let _analyzer = (criteria) => {
    let splitUnit = /\s+/; ///\s*\b/g
    let words = criteria.split(splitUnit);
